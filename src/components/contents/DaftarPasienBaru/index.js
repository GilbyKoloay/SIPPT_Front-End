      ...
      <div className='contentFull'>
        ...
        <form>
          <div className='form'>
            ...
            <TextInput props={{label: 'No. Telepon', value: SUNP_personalData.phoneNumber, onChange: SUNP_personalData_changePhoneNumber}} />
          </div>
          <div className='form'>
            ...
            <Select props={{label: 'Status', options: ['(STATUS)', 'KAWIN', 'TIDAK KAWIN', 'JANDA/DUDA'], value: SUNP_personalData.maritalStatus, onChange: SUNP_personalData_changeMaritalStatus}} />
            <Select props={{label: 'Pekerjaan', options: ['(PEKERJAAN)', 'ASN', 'TNI/POLRI', 'SWASTA', 'PETANI', 'WIRASWASTA', 'PELAJAR', 'PELAJAR/MAHASISWA', 'LAINNYA'], value: SUNP_personalData.job, onChange: SUNP_personalData_changeJob}} />
          </div>
        </form>
        <ButtonClear />
      </div>
